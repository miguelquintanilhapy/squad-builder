...
const inputShellClasses =
  'flex h-[39px] items-center overflow-hidden rounded-[7px] border border-rule-2 bg-paper-3 transition-[border-color,box-shadow] duration-150 hover:border-ink-3 focus-within:border-petrol focus-within:shadow-[0_0_0_3px_rgba(20,88,74,0.13)]'
