      ...
      <div className="mx-auto flex max-w-[640px] flex-col gap-4 p-4">
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <textarea
            ...
            rows={3}
            disabled={loading}
            className="w-full resize-y rounded-[7px] border border-rule-2 bg-paper-3 px-3 py-2 text-sm text-ink outline-none transition-[border-color,box-shadow] duration-150 placeholder:text-ink-3 hover:border-ink-3 focus:border-petrol focus:shadow-[0_0_0_3px_rgba(20,88,74,0.13)] disabled:opacity-50"
          />
